        ...
        static void Main(string[] args)
        {
            ...
            static void List(string entity)
            {
                if (entity == "Cat_Owner")
                {
                    ...
                    {
                        Console.WriteLine(owner.ID + "\t" + owner.Owner_Name);
                    }
                }
                if (entity == "Cat")
                {
                    ...
                    {
                        Console.WriteLine(cat.ID + "\t" + cat.Cat_Name);
                    }
                }
                if (entity == "Cat_Sitter")
                {
                    ...
                    {
                        Console.WriteLine(sitter.ID + "\t" + sitter.Sitter_Name);
                    }
                }
                Console.ReadLine();
            }
            ...
            static void Update(string entity)
            {
                if (entity == "Cat_Owner")
                {
                    ...
                    foreach (var prop in cownerprops)
                    {
                        if (prop.Name == "ID")
                        {
                            ...
                            cowner.ID = int.Parse(Console.ReadLine());
                        }
                        if (prop.Name == "Owner_Name")
                        {
                ...
                if (entity == "Cat_Sitter")
                {
                    ...
                    foreach (var prop in citterprops)
                    {
                        ...
                        {
                            Console.WriteLine("ID: ");
                            cat_sitter.ID = int.Parse(Console.ReadLine());
                        }
